...
def ship_hit(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    if stats.ships_left > 0:
        ...
        #Esvasia a lista de alienígenas e de projéteis
        aliens.empty()
        bullets.empty()
...
def check_bullet_alien_collisions(ai_settings, screen, stats, sb, ship, aliens, bullets):
    """Responde a colisoes entre projéteis e alienigenas."""
...
def get_number_rows(ai_settings, ship_height, alien_height):
    """ Determina o numero de linhas com alienígenas que cabem na tela. """
...
def create_fleet(ai_settings, screen, ship, aliens):
    ...
    # Cria um alienígena e calcula o número de aliegínas em uma linha
    alien = Alien(ai_settings, screen)
...
def check_fleet_edges(ai_settings, aliens):
    """Responde apropriedamente se algum alienígena alcaçou uma borda."""
